...
namespace tryProject.Controllers
{
    public class AssociationsController : Controller
    {
        ...
        {
            var checky = _context.Association.Include(x => x.Zones).Include(x => x.Purposes).Include(w=>w.CommunityWorks).Include(x => x.CatersTo).ToListAsync();
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,City,PurposeName,CommunityWorksDescription,Manager,Website, Email")] Association association, int[]Zones, int[]Purposes, int[] CateringTo, string Manager)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,City,Purpose,CommunityWorks,Manager,Website, Email")] Association association, int[] Zones, int[] Purposes, int[] CateringTo, string Manager)
        {
